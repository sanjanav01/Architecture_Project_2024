...
TEST(ReadPPMTest, ValidPPMFile) {
    /*ppm2.ppm
    std::ofstream file("/Users/shriyasingh/Desktop/architecture_project_2024/Architecture_Project_2024/test_resources/resources/ppm2.ppm", std::ios::binary);
    // PPM Header
    file << "P6\n2 2\n255\n";
    ...
    file.close();
    */
    std::string file_path = "/Users/shriyasingh/Desktop/architecture_project_2024/Architecture_Project_2024/test_resources/resources/ppm2.ppm";
